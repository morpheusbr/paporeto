...
public function doctype ($type='html5', $standard='padrao') {
if (in_array($standard, array('padrao'))) {
if ($type == 'html5') {
$this->xhtml = ' /';
switch ($standard) {
case 'padrao': $this->doctype = '<!DOCTYPE html>'; break;
}
}
}
}
...
echo $msg . '<br /><br /><a href="' . $url . '">Clique para continuar.</a>';
}
exit; 
}
