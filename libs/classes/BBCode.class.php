...
class BBCode {
  ...
  public function __construct () {
    ...
    $this->bbcode_table["/\[quote=\"([^\"]+)\"\](.*?)\[\/quote\]/is"] = function ($match) {
      return "$match[1] Resposta: <blockquote><p>$match[2]</p></blockquote>";
    };
    ...
    $this->bbcode_table["/\[img\](.*?)\[\/img\]/is"] = function ($match) {
      return "<a href=\"$match[1]\"><img width=\"150\" height=\"150\" src=\"$match[1]\"/></a>"; 
    };
    ...
    $this->bbcode_table["/\[youtube\](?:http?:\/\/)?(?:www\.)?youtu(?:\.be\/|be\.com\/watch\?v=)([A-Z0-9\-_]+)(?:&(.*?))?\[\/youtube\]/i"] = function ($match) {
      return "<div class=\"embed-responsive embed-responsive-4by3\"><iframe class=\"embed-responsive-item\" type=\"text/html\" src=\"http://www.youtube.com/embed/$match[1]\" frameborder=\"0\"></iframe></div>";
    };
  }
